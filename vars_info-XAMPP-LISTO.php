...
define("SIGNATURE_HASH", "bp2GGbE8wWkMU1wN81DAIbQRmZkGTxyMmiHIkf+7e1A="); //hash para firmas de descargas
...
define("STREAM_PATH", "/AnimeMovil/stream/"); //dominio o ruto a donde se enviara el stream
